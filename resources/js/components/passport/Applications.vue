        ...
        <div class="card card-default">
            ...
            <div class="card-body">
                ...
                <p class="mb-0" v-if="clients.length === 0">
                    You have not created any Applications.
                </p>
                ...
                <table class="table table-borderless mb-0" v-if="clients.length > 0">
                    ...
                    <tbody>
                        <tr v-for="client in clients">
                            ...
                            <!-- Password app -->
                            <td style="vertical-align: middle;">
                                <code>{{ client.is_native }}</code>
                            </td>

                            <!-- Is active app? -->
                            <td style="vertical-align: middle;">
                                <code>{{ client.is_active }}</code>
                            </td>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form role="form">
                            ...
                            <!-- Native App -->
                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Native Applications</label>

                                <div class="col-md-9">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" v-model="createForm.is_native">
                                        </label>
                                    </div>

                                    <span class="form-text text-muted">
                                        Native applications means SPA or Android Apps.
                                    </span>
                                </div>
                            </div>
                        </form>
                        ...
                        <form role="form">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" v-model="editForm.is_native">
                                        </label>
                                    </div>
    ...
    export default {
        ...
        methods: {
            ...
            edit(client) {
                ...
                this.editForm.is_native = client.is_native;
             ...
             */
            destroy(client) {
                axios.delete('/api/apps/' + client.id)
                        .then(response => {
                            this.getClients();
                        });
            }
